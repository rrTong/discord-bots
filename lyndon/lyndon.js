...
bot.on('message', function (user, userID, channelID, message, evt) {
    if ((userID != bot.id) && (message.match(bot.id) || message.match(/lyndon/i) || message.match(/baines/i) || message.match(/johnson/i) || message.match(/lb/i) || message.match(/bj/i) || message.match(/lj/i) || message.match(/l.b.j/i) || message.match(/leblanc/i) || message.match(/林登/i) || message.match(/貝恩斯/i) || message.match(/約翰遜/i) || message.match(/贝恩斯/i) || message.match(/约翰逊/i) || message.match(/リンドン/i) || message.match(/ジョンソン/i) || message.match(/린든/i) || message.match(/존슨/i) || message.match(/Ли́ндон/i) || message.match(/Бэйнс/i) || message.match(/Джо́нсон/i))) {
